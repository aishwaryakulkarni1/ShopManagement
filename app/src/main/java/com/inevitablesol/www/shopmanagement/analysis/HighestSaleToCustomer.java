...
public class HighestSaleToCustomer extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.highest_sale_to_customer);
    ...
    private void  getTotalSale_Status(final String startDate, final String id)
    {
        ...
        final StringRequest req = new StringRequest(Request.Method.POST, WEBAPI.HighestSaleToCustomer,
                            ...
                            if(message.equalsIgnoreCase("true"))
                            {
                                ...
                                for (int i=0;i<len;i++)
                                {
                                    ...
                                    if(top_seven instanceof Top_seven_Class)
                                    {
                                        ...
                                        top_seven.setInvoice_count(jsonArray.getJSONObject(i).getString("total"));
                                ...
                                Top_class_Adapter top_class_adapter=new Top_class_Adapter(top_seven_classes,HighestSaleToCustomer.this);
